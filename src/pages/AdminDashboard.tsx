...
export default function AdminDashboard() {
  ...
  const handleExportCSV = () => {
    ...
    const rows = paints.map((p) => [p.name, p.code, p.hex, p.category].map(sanitizeCSVCell).join(","));
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Será usado na URL: /empresa/{companySlug || "minha-loja"}</p>
            </div>
